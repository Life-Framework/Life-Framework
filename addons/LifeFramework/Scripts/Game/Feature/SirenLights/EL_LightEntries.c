...
[BaseContainerProps(), EL_BaseContainerCustomTitleFieldEnum("m_Type", EL_LightEntryType)]
...
[BaseContainerProps(), EL_BaseContainerCustomTitleFieldEnum("m_Type", EL_AnimationEntryType)]
