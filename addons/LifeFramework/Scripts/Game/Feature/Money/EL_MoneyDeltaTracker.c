// Ported from Overthrow.Arma4 (MIT): Scripts/Game/Data/OVT_MoneyDeltaTracker.c
//------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------
class EL_MoneyDeltaTracker : Managed
{
	...
	string GetText()
	{
		return EL_MoneyFormat.FormatDelta(m_iDelta);
	}
